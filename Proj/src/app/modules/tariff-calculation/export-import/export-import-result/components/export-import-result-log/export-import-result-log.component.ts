...
@Component({
  selector: 'rom-export-import-result-log',
  templateUrl: './export-import-result-log.component.html',
  styleUrls: ['./export-import-result-log.component.less'],
})
export class ExportImportResultLogComponent
