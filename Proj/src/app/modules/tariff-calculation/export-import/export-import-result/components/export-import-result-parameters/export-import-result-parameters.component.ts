...
@Component({
  selector: 'rom-export-import-result-parameters',
  templateUrl: './export-import-result-parameters.component.html',
  styleUrls: ['./export-import-result-parameters.component.less'],
})
export class ExportImportResultParametersComponent
  ...
  downloadFile(files: File[]) {
    ...
    this.exportImportService
      ...
      .subscribe((files) => {
        ...
        this.errorsContentValidationForms = [{ShortMessage: AppLocalization.NoFileFound}];
      });
  }
}
