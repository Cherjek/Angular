...
@Component({
    selector: 'frame-reports-result-log',
    templateUrl: 'reports.result.log.html',
    styleUrls: ['reports.result.log.css']
})

export class ReportsResultLogComponent implements OnInit, OnDestroy {

    constructor(
        private activateRoute: ActivatedRoute,
        private dsLogs: ReportResultLogsService) {
